...
**26 native models are available for paid inference.** All 155 provider-backed models remain catalog-only, including MiniMax M3 at the owner's explicit request. Of the other 58 native or legacy models, 27 are unavailable, 19 use unsupported billing units, and 12 lack verified usage metering. Adding catalog entries does not enable their inference adapters or authorize estimated charges.
...
## Available token rates

These are LayerRail prices in USD per million tokens. Actual invoice calculation uses the dated billing resources in `config/billing_rates/cloudflare.yml`; display quotes live separately in `config/cloudflare_catalog_pricing.json`.

| Model | Input | Output | Cached input |
|---|---:|---:|---:|
| `@cf/meta/llama-3.2-3b-instruct` | 0.05599 | 0.3685 | — |
| `@cf/openai/gpt-oss-20b` | 0.22 | 0.33 | — |
| `@cf/openai/gpt-oss-120b` | 0.385 | 0.825 | — |
| `@cf/aisingapore/gemma-sea-lion-v4-27b-it` | 0.3861 | 0.6105 | — |
| `@cf/deepseek-ai/deepseek-r1-distill-qwen-32b` | 0.5467 | 5.3691 | — |
| `@cf/google/gemma-4-26b-a4b-it` | 0.11 | 0.33 | — |
| `@cf/ibm-granite/granite-4.0-h-micro` | 0.0187 | 0.1232 | — |
| `@cf/meta/llama-3.1-8b-instruct-fp8` | 0.1672 | 0.3157 | — |
| `@cf/meta/llama-3.2-1b-instruct` | 0.0297 | 0.2211 | — |
| `@cf/meta/llama-3.3-70b-instruct-fp8-fast` | 0.3223 | 2.4783 | — |
| `@cf/meta/llama-4-scout-17b-16e-instruct` | 0.297 | 0.935 | — |
| `@cf/meta/llama-guard-3-8b` | 0.5324 | 0.033 | — |
| `@cf/mistralai/mistral-small-3.1-24b-instruct` | 0.3861 | 0.6105 | — |
| `@cf/moonshotai/kimi-k2.6` | 1.045 | 4.4 | 0.176 |
| `@cf/moonshotai/kimi-k2.7-code` | 1.045 | 4.4 | 0.209 |
| `@cf/nvidia/nemotron-3-120b-a12b` | 0.55 | 1.65 | — |
| `@cf/qwen/qwen2.5-coder-32b-instruct` | 0.726 | 1.1 | — |
| `@cf/qwen/qwen3-30b-a3b-fp8` | 0.05599 | 0.3685 | — |
| `@cf/qwen/qwq-32b` | 0.726 | 1.1 | — |
| `@cf/zai-org/glm-4.7-flash` | 0.06655 | 0.44 | — |
| `@cf/zai-org/glm-5.2` | 1.54 | 4.84 | 0.286 |
| `@cf/deepseek-ai/deepseek-v4-flash-0731` | 0.484 | 1.452 | 0.0154 |
| `@cf/deepseek-ai/deepseek-v4-pro-0813` | 1.452 | 4.356 | 0.0484 |
| `@cf/qwen/qwen3.8-27b` | 0.495 | 3.52 | 0.055 |
| `@cf/zai-org/glm-5.3` | 1.54 | 4.84 | 0.286 |
| `@cf/zai-org/glm-5.3-flash` | 0.165 | 0.55 | 0.033 |

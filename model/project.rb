...
class Project < Sequel::Model
  ...
  one_to_many :domain_bundles, read_only: true
  ...
  RESOURCE_ASSOCIATIONS = %i[vms deploy_apps game_vpses minio_clusters private_subnets postgres_resources firewalls load_balancers edge_services domain_registrations domain_bundles kubernetes_clusters github_runners ai_agents ai_knowledge_bases]

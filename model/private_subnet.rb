...
class PrivateSubnet < Sequel::Model
  ...
  one_to_one :private_subnet_linode_resource, key: :id, read_only: true
...
#  private_subnet_linode_resource | private_subnet_linode_resource_id_fkey           | (id) REFERENCES private_subnet(id) ON DELETE CASCADE

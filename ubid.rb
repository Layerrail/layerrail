...
class UBID
  ...
  TYPE_GAME_VPS = "gx"
  TYPE_DEPLOY_APP = "dp"
  TYPE_DEPLOY_DEPLOYMENT = "d1"
  TYPE_DEPLOY_VARIABLE = "d2"
  TYPE_AI_KNOWLEDGE_BASE = "a0"
  TYPE_AI_KNOWLEDGE_DOCUMENT = "a2"
  TYPE_AI_KNOWLEDGE_CHUNK = "a3"
  TYPE_AI_AGENT = "a4"
  TYPE_AI_AGENT_EVENT = "a5"
  TYPE_DOMAIN_REGISTRATION = "dn"
  TYPE_DOMAIN_CONTACT_PROFILE = "d3"
  TYPE_DOMAIN_TLD = "d4"
  TYPE_DOMAIN_ORDER = "d0"
  TYPE_DOMAIN_BUNDLE = "d5"
  # TYPE_AUDIT_LOG = "a1"
